...
// --- Refactored Search Grounding Logic ---
...
// Parser for Brand Reputation Analysis
const brandReputationParser = (text) => {
...
const marketPulseParser = (text) => {
    ...
    const consumerPainPoints = parseList(parseSection('Consumer Pain Points', text));
    const topBrands = parseList(parseSection('Top Brands', text));
